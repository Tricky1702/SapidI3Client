...
/* Intermud 3 channel allow list */
#define I3_ALLOW_LIST    "/adm/etc/i3_channels"
...
/* Define this if you want to use /adm/etc/i3_channels
   to filter which channels on I3 to use.

   Undefine if you want to listen to all public channels.
*/
#define USE_I3_CHANNELS_FILE
#undef USE_I3_CHANNELS_FILE
