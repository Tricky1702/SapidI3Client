 ...
 *
 * Needs coding. This is just a copy of oob_mod_file.c
 *
 */
...
staticv mapping ls_ids, put_ids, get_ids;
staticv string put_status, get_status;
staticv int put_packet_size, put_ctr, put_success;
staticv int put_ack_packet_size, put_ack_ctr;
staticv int get_packet_size, get_ctr;
...
void list_req_handler(mixed array packet)
{
    mixed array dirstat;
    string dir = packet[3];
...
void list_reply_handler(mixed array packet)
{
    object user;
    mixed array dir;
    mixed array ls_data;
...
void put_handler(mixed array packet)
{
...
void put_ack_handler(mixed array packet)
{
    object user;
...
void get_req_handler(mixed array packet)
{
    string array packets = ({ });
...
void get_reply_handler(mixed array packet)
{
    object user;
