...
#define I3_DEF_ROUTER_NAME   (routerList[I3_INDEX]["name"])
#define I3_DEF_ROUTER_IP     (routerList[I3_INDEX]["ip"])
#define I3_DEF_ROUTER_PORT   (routerList[I3_INDEX]["port"])

staticv mapping  services;

/* Heartbeat timer */
staticv int      hb_timer;

/* Idle timer */
staticv int      idleTimeout;

staticv string array Days = ({
  "Sunday",
  "Monday",
  "Tuesday",
  "Wednesday",
...
staticv mapping SpecialOrdinals = ([
  0: "th",
  1: "st",
  2: "nd",
  3: "rd",
